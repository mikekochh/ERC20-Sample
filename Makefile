...
# adding @ symbol will prevent terminal from showing what command was just run. This is good if you are using a private key and don't want it to show in terminal
